...
#            filtrare risposte con le parole che ci sono nella domanda
...
if(non==0 and stessoanno==0 and entrambe==0 and prima==0 and precedente==0 and nessuno==0 and dopo==0 and quando==0):
    ...
    if(ca1==0 and ca2==0 and ca3==0): print(colored('NO MATCHES FOUND','red'))
    if(ca1==ca2 and ca2>ca3): print(colored('MATCHES FOUND: A or B','red'))
    if(ca2==ca3 and ca2>ca1): print(colored('MATCHES FOUND: B or C','red'))
    if(ca1==ca3 and ca1>ca2): print(colored('MATCHES FOUND: A or C','red'))
    if(ca1==ca3 and ca1==ca2 and ca1!=0): print(colored('MATCHES FOUND: all true','red'))

        
    if(ca1!=0 and ca1>ca2 and ca1>ca3):
        print(colored("A: " + ans_1F,'red'))
        print("Percentage: "+ str(p1)+"%")
        x=180
        y=333
    ...
    if(ca2!=0 and ca2>ca1 and ca2>ca3):
        print(colored("B: " + ans_2F,'red'))
        print("Percentage: "+ str(p2)+"%")
        x=180
        y=409
    ...
    if(ca3!=0 and ca3>ca1 and ca3>ca2):
        print(colored("C: " + ans_3F,'red'))
        print("Percentage: "+ str(p3)+"%")
        x=180
        y=483
...
#10,270,295,353 // 10,270,10-295,270-353 // 10,270,285,83 // 10,270,285+10,270+83 // a,b,a+c,b+d

#if(int(nr)==1):
#    print("check: window 1")
#    os.system("screencapture -x -R 10,216,335,29 /Users/liux/Desktop/LQ/quest.png")
#    os.system("screencapture -x -R 34,281,291,54 /Users/liux/Desktop/LQ/ans_1.png")
#    os.system("screencapture -x -R 34,355,291,57 /Users/liux/Desktop/LQ/ans_2.png")
#    os.system("screencapture -x -R 34,430,291,57 /Users/liux/Desktop/LQ/ans_3.png")


#if(int(nr)==2):
#    print("check: window 2")
#    os.system("screencapture -x -R 10,211,335,54 /Users/liux/Desktop/LQ/quest.png")
#    os.system("screencapture -x -R 34,296,291,58 /Users/liux/Desktop/LQ/ans_1.png")
#    os.system("screencapture -x -R 34,371,291,57 /Users/liux/Desktop/LQ/ans_2.png")
#    os.system("screencapture -x -R 34,445,291,57 /Users/liux/Desktop/LQ/ans_3.png")


#if(int(nr)==3):
#    print("check: window 3")
#    os.system("screencapture -x -R 10,204,335,84 /Users/liux/Desktop/LQ/quest.png")
#    os.system("screencapture -x -R 34,312,291,58 /Users/liux/Desktop/LQ/ans_1.png")
#    os.system("screencapture -x -R 34,387,291,58 /Users/liux/Desktop/LQ/ans_2.png")
#    os.system("screencapture -x -R 34,461,291,57 /Users/liux/Desktop/LQ/ans_3.png")


#if(int(nr)==4):
#    print("check: window 4")
#    os.system("screencapture -x -R 10,199,335,113 /Users/liux/Desktop/LQ/quest.png")
#    os.system("screencapture -x -R 34,328,291,57 /Users/liux/Desktop/LQ/ans_1.png")
#    os.system("screencapture -x -R 34,403,291,57 /Users/liux/Desktop/LQ/ans_2.png")
#    os.system("screencapture -x -R 34,477,291,57 /Users/liux/Desktop/LQ/ans_3.png")
...
#quest = pyautogui.screenshot(region=(10,216,335,29))
#quest.save(os.path.join(DIR,'cache','quest.png'))
