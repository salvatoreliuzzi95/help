...
BOW = list(set(BOW.lower().split()+quest.lower().replace('"','').strip().split())) #bag of words
...
if(entrambe==1):
    ...
    if(ans_3F.find("Entrambe")>-1 or ans_3F.find("Entrambi")>-1): # Entrambe è la risposta 3
        ...
        todelete=[]
        for k in range(0,len(ans_1)):
            if(len(ans_1[k])<3):
                todelete.append(ans_1[k])
        for k in range(0,len(todelete)):
            ans_1.remove(todelete[k])
        ...
        todelete=[]
        for k in range(0,len(ans_2)):
            if(len(ans_2[k])<3):
                todelete.append(ans_2[k])
        for k in range(0,len(todelete)):
            ans_2.remove(todelete[k])
    ...
    if(ans_2F.find("Entrambe")>-1 or ans_2F.find("Entrambi")>-1): # Entrambe è la risposta 2
        ...
        todelete=[]
        for k in range(0,len(ans_3)):
            if(len(ans_3[k])<3):
                todelete.append(ans_3[k])
        for k in range(0,len(todelete)):
            ans_3.remove(todelete[k])
