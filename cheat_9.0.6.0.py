...
if(quest.find(' NON ')>-1 or quest.find(' NON')>-1 or quest.find('falsa?')>-1 or quest.find(' non ')>-1 or quest.find(' mai ')>-1): non=1
    
if(quest.find("Quando ")>-1 or quest.find("verificato:")>-1):
    if(ans_1F.find("Prima ")>-1 or ans_1F.find("Dopo ")>-1 or ans_1F.find("Tra ")>-1 or ans_1F.find("Lo stesso ")>-1 or ans_1F.find("Durante ")>-1): 
        quando=1
        
if(quest.find(" nord?")>-1):
    nord=1
if(quest.find(" sud?")>-1):
    sud=1
if(quest.find(" est?")>-1):
    est=1
if(quest.find(" ovest?")>-1):
    ovest=1
...
if(nord==1 or sud==1 or est==1 or ovest==1):
    ...
    goans1=open(os.path.join(DIR,'cache','goans1.txt'), 'r',encoding='utf8',errors="ignore").read()
    goans2=open(os.path.join(DIR,'cache','goans2.txt'), 'r',encoding='utf8',errors="ignore").read()
    goans3=open(os.path.join(DIR,'cache','goans3.txt'), 'r',encoding='utf8',errors="ignore").read()
